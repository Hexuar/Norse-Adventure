...
execute if entity @s[tag=norse_adventure.ship.drakkar] run function norse_adventure:ships/drakkar/assemble
scoreboard players set #assemble norse_adventure.value 0