...
# Hitbox
summon villager ~ ~ ~ {NoGravity:1b,Silent:1b,NoAI:1b,Tags:["norse_adventure.unregistered","norse_adventure.entity","norse_adventure.ship_part","norse_adventure.ship_part.hitbox"],active_effects:[{id:"minecraft:invisibility",amplifier:1b,duration:-1,show_particles:0b}],VillagerData:{profession:"minecraft:nitwit"}}
