# Floors
tp @e[type=marker,tag=norse_adventure.current,tag=norse_adventure.ship.skeid.floor_5] ^ ^0.5 ^7.5
tp @e[type=marker,tag=norse_adventure.current,tag=norse_adventure.ship.skeid.floor_4] ^ ^0.5 ^6
tp @e[type=marker,tag=norse_adventure.current,tag=norse_adventure.ship.skeid.floor_3] ^ ^0.5 ^4.5
tp @e[type=marker,tag=norse_adventure.current,tag=norse_adventure.ship.skeid.floor_2] ^ ^0.5 ^3
tp @e[type=marker,tag=norse_adventure.current,tag=norse_adventure.ship.skeid.floor_1] ^ ^0.5 ^1.5
tp @e[type=marker,tag=norse_adventure.current,tag=norse_adventure.ship.skeid.floor_0] ^ ^0.5 ^
tp @e[type=marker,tag=norse_adventure.current,tag=norse_adventure.ship.skeid.floor_-1] ^ ^0.5 ^-1.5
tp @e[type=marker,tag=norse_adventure.current,tag=norse_adventure.ship.skeid.floor_-2] ^ ^0.5 ^-3
tp @e[type=marker,tag=norse_adventure.current,tag=norse_adventure.ship.skeid.floor_-3] ^ ^0.5 ^-4.5
tp @e[type=marker,tag=norse_adventure.current,tag=norse_adventure.ship.skeid.floor_-4] ^ ^0.5 ^-6
tp @e[type=marker,tag=norse_adventure.current,tag=norse_adventure.ship.skeid.floor_-5] ^ ^0.5 ^-7.5
