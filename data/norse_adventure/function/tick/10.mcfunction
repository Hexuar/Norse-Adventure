...
# Advancements
execute as @a at @s if score @e[type=item_display,tag=norse_adventure.ship.skeid,distance=..10,sort=nearest,limit=1] norse_adventure.speed matches 8.. run advancement grant @s only norse_adventure:tutorial/speed
